...
def aiida_localhost_computer(new_workdir):
    ...
    """
    from aiida_vasp_bm.helpers import get_computer
...
def aiida_code(aiida_localhost_computer):
    ...
    """
    from aiida_vasp_bm.helpers import get_code

    code = get_code(entry_point='vasp_bm', computer=aiida_localhost_computer)
