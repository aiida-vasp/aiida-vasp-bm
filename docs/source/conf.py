#
# Sphinx configuration for aiida-vasp-bm
#
...
project = "aiida-vasp-bm"
copyright_first_year = "2023"
copyright_owners = "The AiiDA-VASP developer team"
...
release = aiida_vasp_bm.__version__
...
html_title = f"aiida-vasp-bm v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-vasp-bm.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_vasp_bm")
