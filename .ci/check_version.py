...
Check version number in setup.json and aiida_vasp_bm/__init__.py and make sure
they match.
"""
...
import aiida_vasp_bm  # pylint: disable=wrong-import-position
version = aiida_vasp_bm.__version__
