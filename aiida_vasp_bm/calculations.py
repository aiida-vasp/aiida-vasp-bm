"""
Calculations provided by aiida_vasp_bm.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.input('metadata.options.parser_name', valid_type=six.string_types, default='vasp_bm')
        ...
        spec.output('vasp_bm', valid_type=SinglefileData, help='diff between file1 and file2.')
